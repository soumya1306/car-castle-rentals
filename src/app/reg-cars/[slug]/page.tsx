...
const CarDetailsPage = ({ params }: CarDetailsPageProps) => {
  ...
  const handleFormSubmit = async(formData: FormData) => {
    ...
    const whatsappMessage = `Hello! I'm interested in booking a car from Car Castle Rentals.
...
Please confirm the availability and provide further details for the booking.
    ...
    <div className="px-6 md:px-16 lg:px-24 xl:px-32 mt-16">
      ...
      {carDetails ? (
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:mb-12">
          ...
          <form
            className="flex flex-col shadow-lg h-max sticky top-18 rounded-xl py-6 px-4 space-y-6 bg-white text-gray-500 justify-center"
